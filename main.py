...
def task_3(n):
    ...
    a = pollard(n)
    if a != n:
        factorize_numvers.append(a)
        print('дiльник a знайдено, переходимо до наступного кроку', n//a)
        return task_4(n//a)
    else:
        return task_5(n)
...
n = int(input('Enter n: '))
task_1(n)
print('Канонiчний розклад числа: ', factorize_numvers)